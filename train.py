...
class Train:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="TRAIN DATA SET",font=("Arial Black",35,"bold"),bg="WHITE",fg="RED")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        img_top=Image.open(r"C:\Users\hp\Desktop\face_recognition_system\college_images\facialrecognition.png")
